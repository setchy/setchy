...
- MERGED - [refactor: remove dependency track spec downgrade](https://github.com/CycloneDX/cdxgen/pull/642) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [3 days ago]

- MERGED - [build: add codeowners file](https://github.com/gitify-app/gitify/pull/672) to [gitify-app/gitify](https://github.com/gitify-app/gitify) [4 days ago]

- MERGED - [refactor: replace substr with substring](https://github.com/gitify-app/gitify/pull/671) to [gitify-app/gitify](https://github.com/gitify-app/gitify) [4 days ago]
...
- CLOSED - [build: add vscode settings and extensions for auto pretty on save](https://github.com/CycloneDX/cdxgen/pull/584) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [3 weeks ago]

- MERGED - [feat(server): support dtrack publishing](https://github.com/CycloneDX/cdxgen/pull/583) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [3 weeks ago]

- CLOSED - [feat(server): set projectType is passed via POST JSON Body](https://github.com/CycloneDX/cdxgen/pull/582) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [3 weeks ago]

- MERGED - [docs: add server arguments](https://github.com/CycloneDX/cdxgen/pull/581) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [3 weeks ago]
...
- [copier-org/copier](https://github.com/copier-org/copier) 1301⭐

- [wayfair-incubator/gqmock](https://github.com/wayfair-incubator/gqmock) 4⭐

- [jeremylong/DependencyCheck](https://github.com/jeremylong/DependencyCheck) 5415⭐
...
- [Apicurio/apicurio-registry](https://github.com/Apicurio/apicurio-registry) 464⭐

- [docsifyjs/docsify](https://github.com/docsifyjs/docsify) 25235⭐

- [SonarSource/sonarqube](https://github.com/SonarSource/sonarqube) 8125⭐

- [github/innovationgraph](https://github.com/github/innovationgraph) 206⭐

- [steven-tey/dub](https://github.com/steven-tey/dub) 12604⭐

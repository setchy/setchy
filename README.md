...
- [graphql-java-kickstart/graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) - A schema-first tool for graphql-java inspired by graphql-tools for JS [1 day ago]
...
- [setchy/renovate-atlaskit-changelog-two](https://github.com/setchy/renovate-atlaskit-changelog-two) -  [6 days ago]

- [setchy/renovate-atlaskit-changelog](https://github.com/setchy/renovate-atlaskit-changelog) -  [1 week ago]
...
- MERGED - [docs: update website url](https://github.com/graphql-java-kickstart/graphql-java-tools/pull/793) to [graphql-java-kickstart/graphql-java-tools](https://github.com/graphql-java-kickstart/graphql-java-tools) [1 day ago]

- OPEN - [fix: win32 asset matching pattern](https://github.com/electron/update.electronjs.org/pull/175) to [electron/update.electronjs.org](https://github.com/electron/update.electronjs.org) [5 days ago]

- OPEN - [Update dependency @atlaskit/heading to v3](https://github.com/setchy/renovate-atlaskit-changelog-two/pull/3) to [setchy/renovate-atlaskit-changelog-two](https://github.com/setchy/renovate-atlaskit-changelog-two) [6 days ago]

- OPEN - [Update Atlassian Atlaskit packages](https://github.com/setchy/renovate-atlaskit-changelog-two/pull/2) to [setchy/renovate-atlaskit-changelog-two](https://github.com/setchy/renovate-atlaskit-changelog-two) [6 days ago]

- OPEN - [Update pnpm to v9.14.2](https://github.com/setchy/renovate-atlaskit-changelog-two/pull/1) to [setchy/renovate-atlaskit-changelog-two](https://github.com/setchy/renovate-atlaskit-changelog-two) [6 days ago]

- MERGED - [feat: convert `sourceDirectory` to a template eligible config](https://github.com/renovatebot/renovate/pull/32701) to [renovatebot/renovate](https://github.com/renovatebot/renovate) [6 days ago]

- MERGED - [refactor: update filters match expressions to include space](https://github.com/setchy/atlassify/pull/379) to [setchy/atlassify](https://github.com/setchy/atlassify) [6 days ago]
...
- CLOSED - [Configure Renovate - autoclosed](https://github.com/setchy/renovate-atlaskit-changelog/pull/10) to [setchy/renovate-atlaskit-changelog](https://github.com/setchy/renovate-atlaskit-changelog) [1 week ago]
...
- [desktop/desktop](https://github.com/desktop/desktop) 19918⭐

- [dockur/macos](https://github.com/dockur/macos) 9145⭐

- [dockur/windows](https://github.com/dockur/windows) 30029⭐
...
- [pulumi/pulumi](https://github.com/pulumi/pulumi) 21933⭐

- [hcengineering/platform](https://github.com/hcengineering/platform) 17547⭐

- [dotansimha/graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) 10871⭐

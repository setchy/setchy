...
[![Skills](https://skills.syvixor.com/api/icons?perline=10&i=javascript,typescript,nodejs,java,spring,springboot,html,css3,reactjs,tailwindcss,electron,vuejs,astro,pnpm,npm,apachemaven,vite,vitest,expressjs,graphql,apollo,postman,bitbucket,confluence,jira,docker,intellijidea,visualstudiocode,renovate,openapi,slack,drawio)](https://github.com/syvixor/skills-icons)

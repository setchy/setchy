...
- MERGED - [docs(faq): view app log menu](https://github.com/gitify-app/website/pull/264) to [gitify-app/website](https://github.com/gitify-app/website) [2 days ago]

- MERGED - [refactor: tray icons](https://github.com/gitify-app/gitify/pull/1633) to [gitify-app/gitify](https://github.com/gitify-app/gitify) [2 days ago]

- MERGED - [feat(menu): view application logs](https://github.com/gitify-app/gitify/pull/1632) to [gitify-app/gitify](https://github.com/gitify-app/gitify) [2 days ago]

- MERGED - [fix: hide repo stats on small screens](https://github.com/gitify-app/website/pull/261) to [gitify-app/website](https://github.com/gitify-app/website) [3 days ago]

- OPEN - [refactor: octokit openapi types](https://github.com/gitify-app/gitify/pull/1626) to [gitify-app/gitify](https://github.com/gitify-app/gitify) [3 days ago]

- MERGED - [refactor: docs](https://github.com/setchy/atlassify/pull/340) to [setchy/atlassify](https://github.com/setchy/atlassify) [3 days ago]

- MERGED - [feat: github stats, astro icons and octokit](https://github.com/gitify-app/website/pull/260) to [gitify-app/website](https://github.com/gitify-app/website) [3 days ago]

- MERGED - [refactor: astro icon local](https://github.com/setchy/atlassify/pull/339) to [setchy/atlassify](https://github.com/setchy/atlassify) [3 days ago]

- MERGED - [chore(deps): update @atlaskit primitives and tooltip](https://github.com/setchy/atlassify/pull/338) to [setchy/atlassify](https://github.com/setchy/atlassify) [4 days ago]

- MERGED - [feat: add github status and astro-icons](https://github.com/setchy/atlassify/pull/333) to [setchy/atlassify](https://github.com/setchy/atlassify) [5 days ago]
...
- [pulumi/pulumi](https://github.com/pulumi/pulumi) 21818⭐

- [hcengineering/platform](https://github.com/hcengineering/platform) 17199⭐

- [dotansimha/graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) 10853⭐

- [apollosolutions/schema-shaker](https://github.com/apollosolutions/schema-shaker) 5⭐

- [electron/electron](https://github.com/electron/electron) 114383⭐

- [getgrit/gritql](https://github.com/getgrit/gritql) 3150⭐

- [jucr-io/pathfinder](https://github.com/jucr-io/pathfinder) 7⭐

- [chalk/chalk](https://github.com/chalk/chalk) 21965⭐

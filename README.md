...
- OPEN - [build: add eslint prettier plugin](https://github.com/CycloneDX/cdxgen/pull/607) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [1 day ago]

- CLOSED - [build: add eslint prettier plugin](https://github.com/CycloneDX/cdxgen/pull/606) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [2 days ago]

- MERGED - [feat(server) add simple health endpoint](https://github.com/CycloneDX/cdxgen/pull/605) to [CycloneDX/cdxgen](https://github.com/CycloneDX/cdxgen) [2 days ago]
...
- [docsifyjs/docsify](https://github.com/docsifyjs/docsify) 25100⭐

- [SonarSource/sonarqube](https://github.com/SonarSource/sonarqube) 8083⭐

- [github/innovationgraph](https://github.com/github/innovationgraph) 184⭐

- [steven-tey/dub](https://github.com/steven-tey/dub) 12240⭐

- [sindresorhus/awesome-nodejs](https://github.com/sindresorhus/awesome-nodejs) 52997⭐

- [DopplerHQ/awesome-interview-questions](https://github.com/DopplerHQ/awesome-interview-questions) 58016⭐

- [tauri-apps/tauri](https://github.com/tauri-apps/tauri) 68923⭐
